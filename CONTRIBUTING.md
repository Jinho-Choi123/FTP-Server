...
Follow [git-flow](https://danielkummer.github.io/git-flow-cheatsheet/index.html) to manage branches. For branch history, see the [branches](https://github.com/Jinho-Choi123/FTP-Server/branches) on this repository.

## Versioning

Use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/Jinho-Choi123/FTP-Server/tags).